Template.updateAccountModalInner.helpers({
	...
	userInScope: function() {
	    console.log(Session.get('userInScope'));
	...
	unsetRoles: function() {
		...
		//console.log(this.roles.__global_roles__);
		if (!this.roles || !this.roles.__global_roles__) {
			return allRoles;
		}
		return _.difference(allRoles, this.roles.__global_roles__);
	}
});
